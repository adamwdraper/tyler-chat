...
export const TYLER_CHAT_VERSION = '0.4.0'; // The version of this chat application itself
export const TYLER_COMPATIBLE_VERSION = '0.4.0'; // Update this when testing with new Tyler versions
